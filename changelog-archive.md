...
description: Server Assistant — older releases (v5.4 and earlier).
---

# 📋 Changelog archive

Older Server Assistant releases (v5.4 and earlier). For the current release line, see the [latest changelog]({{ site.url }}{{ site.baseurl }}/changelog/).
