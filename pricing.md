...
.add-cta { display: inline-flex; align-items: center; justify-content: center; gap: .6rem; box-sizing: border-box; text-align: center; padding: .85rem 1.7rem; border-radius: 999px; font-weight: 700; font-size: 1.05rem; text-decoration: none !important; background: #5865F2; color: #fff !important; }
.add-cta:hover { background: #4752c4; }
