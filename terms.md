...
The Bot offers optional AI features (Concierge, Report Message, Self-trained AutoMod, Pulse, `/imagine`) powered by Anthropic and optionally by third-party providers (xAI, OpenAI) when you supply your own key:
