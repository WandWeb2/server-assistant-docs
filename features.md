...
<div class="cmp">
  ...
  <div class="col free">
    <div class="xgrid">
      ...
      <details class="x"><summary>🔔 <strong>Notifications hub</strong> <span class="t">— updates + instant alerts</span></summary><div class="b"><p>One place for every way the bot keeps you posted (<code>/settings → 🔔 Notifications</code>), split in two:</p><table><thead><tr><th>Section</th><th>Controls</th></tr></thead><tbody><tr><td><strong>Updates &amp; digests</strong></td><td>Set <strong>Pulse</strong> to Off / Daily / Weekly / Monthly, and toggle <strong>Milestones</strong> and <strong>Announcements</strong> on or off — your cadence, your call.</td></tr><tr><td><strong>Instant alerts</strong></td><td>Which staff roles get pinged on <strong>raids / approval requests / AutoMod escalations</strong> — live, because you can't put a raid on a weekly digest.</td></tr></tbody></table><p>Existing Pulse settings carry over automatically.</p></div></details>
