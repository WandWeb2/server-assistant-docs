...
<div class="wiz" data-wiz>
      ...
      <div class="dc-row"><img class="dc-av" src="{{ '/assets/logo.png' | relative_url }}" alt="Server Assistant" loading="lazy"><div class="dc-body">
        ...
        <div class="dc-embed blue">
          ...
          <div class="dc-btns">
            ...
            <span class="dc-btn grey">Set bot nickname</span>
          </div>
          <div class="dc-btns">
    ...
    <div class="dc">
      <div class="dc-row"><img class="dc-av" src="{{ '/assets/logo.png' | relative_url }}" alt="Server Assistant" loading="lazy"><div class="dc-body">
        ...
        <div class="dc-embed blue">
          ...
          <div class="dc-btns">
            <span class="dc-btn grey">Approval timeout</span>
          ...
          <div class="dc-btns">
            ...
            <span class="dc-btn grey">Toggle Threat Score</span>
  ...
  <div class="wiz-step" data-step="Verification · Reception">
    ...
    <p class="wiz-caption"><strong>Verification.</strong> New members land at <strong>Reception</strong>, an in-server welcome desk with a banner, greeting and a <strong>Verify me</strong> button that opens a quick are-you-human check (a wrong answer just retries, never bans). Pick the role handed out on success, then choose <strong>who gets held</strong>: <strong>Off</strong> (no gate), <strong>Intelligent</strong> (holds only risk-scored joins for staff to <em>Approve / Kick / Ban</em>) or <strong>On</strong> (everyone verifies). You must choose a role before the gate can switch on. If your server's <strong>Discord Onboarding</strong> could hand out that role on its own (which would let members skip the gate), setup offers to fix it right there, either removing the role from Onboarding for you or creating a fresh verified role Onboarding does not touch. Every server gets a <strong>banner</strong>, created once automatically from the bot's read of your community, plus the greeting you word yourself. On <span class="wiki-prem">PREMIUM</span>, <strong>Reception desk</strong> adds a custom banner image of your own, a custom receptionist name and persona, and a concierge that moves a member who reaches out into a private ticket where SAi helps one-to-one.</p>
  </div>
    ...
    <div class="dc">
      <div class="dc-row"><img class="dc-av" src="{{ '/assets/logo.png' | relative_url }}" alt="Server Assistant" loading="lazy"><div class="dc-body">
        ...
        <div class="dc-embed amber">
          ...
          <div class="dc-fname">Dangerous-action approval</div>
    ...
    <div class="dc-row"><img class="dc-av" src="{{ '/assets/logo.png' | relative_url }}" alt="Server Assistant" loading="lazy"><div class="dc-body">
      ...
      <div class="dc-embed blue">
        ...
        <div class="dc-btns">
          ...
          <span class="dc-btn grey">Adjust</span>
        </div>
      </div>
    </div></div>
  </div>
  ...
  <div class="dc">
    <div class="dc-row"><img class="dc-av" src="{{ '/assets/logo.png' | relative_url }}" alt="Server Assistant" loading="lazy"><div class="dc-body">
      ...
      <div class="dc-embed blue">
        ...
        <div class="dc-btns">
          <span class="dc-btn grey">Toggle NL Commands</span>
    ...
    <div class="dc-row"><img class="dc-av" src="{{ '/assets/logo.png' | relative_url }}" alt="Server Assistant" loading="lazy"><div class="dc-body">
      ...
      <div class="dc-embed blue">
        ...
        <div class="dc-btns">
          ...
          <span class="dc-btn grey">Edit message</span>
...
**Edit message** opens a text box (up to 2000 characters) where you write your
