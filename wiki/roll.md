...
summary: Settle giveaways and loot with /roll — a timed group roll where everyone taps Need, Greed or Pass, each gets a hidden 1–100 roll, and (WoW-style) Need beats Greed with the highest roll winning.
...
2. Everyone taps their choice. Each person is given a **hidden 1–100 roll**, locked
...
- **`seconds`** — how long the roll stays open, **10–300** seconds (default **60**).
