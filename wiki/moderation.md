  ...
  <div class="dc" style="margin-top:1rem;">
    ...
    <div class="dc-row"><img class="dc-av" src="{{ '/assets/logo.png' | relative_url }}" alt="Server Assistant" loading="lazy"><div class="dc-body">
      ...
      <div class="dc-embed amber">
        <div class="dc-title">Warning issued</div>
...
<div class="cmd-card">
  ...
  <div class="dc" style="margin-top:1rem;">
    ...
    <div class="dc-row"><img class="dc-av" src="{{ '/assets/logo.png' | relative_url }}" alt="Server Assistant" loading="lazy"><div class="dc-body">
      ...
      <div class="dc-embed amber">
        <div class="dc-title">Warnings for Troublemaker</div>
...
<div class="cmd-card">
  ...
  <table class="cmd-args">
    ...
    <tr><td><code>minutes</code> <span class="req">required</span></td><td>number</td><td>Duration in minutes (1 to 40320, i.e. up to 28 days).</td></tr>
...
<div class="cmd-card">
  ...
  <div class="dc" style="margin-top:1rem;">
    ...
    <div class="dc-row"><img class="dc-av" src="{{ '/assets/logo.png' | relative_url }}" alt="Server Assistant" loading="lazy"><div class="dc-body">
      <div class="dc-head"><span class="dc-name">Server Assistant</span><span class="dc-bot">App</span><span class="dc-time">today</span></div>
      <div class="dc-embed blue">
        <div class="dc-title">Nickname updated</div>
...
<div class="cmd-card">
  ...
  <table class="cmd-args">
    ...
    <tr><td><code>reason</code> <span class="opt">optional</span></td><td>text</td><td>Optional reason for the log.</td></tr>
    <tr><td><code>delete_days</code> <span class="opt">optional</span></td><td>number</td><td>Days of their messages to delete (0 to 7). Defaults to 0.</td></tr>
  </table>
  <div class="dc" style="margin-top:1rem;">
    <div class="dc-row"><img class="dc-av you" src="{{ '/assets/avatar-you.jpg' | relative_url }}" alt="You" loading="lazy"><div class="dc-body">
      <div class="dc-head"><span class="dc-name">You</span><span class="dc-time">today</span></div>
...
<div class="cmd-card">
  ...
  <div class="dc" style="margin-top:1rem;">
    ...
    <div class="dc-row"><img class="dc-av" src="{{ '/assets/logo.png' | relative_url }}" alt="Server Assistant" loading="lazy"><div class="dc-body">
      <div class="dc-head"><span class="dc-name">Server Assistant</span><span class="dc-bot">App</span><span class="dc-time">today</span></div>
      <div class="dc-embed green">
        <div class="dc-title">Ban lifted</div>
...
<div class="cmd-card">
  ...
  <table class="cmd-args">
    ...
    <tr><td><code>duration</code> <span class="req">required</span></td><td>text</td><td>How long, e.g. <code>30m</code>, <code>2h</code>, <code>7d</code>, <code>1w</code> (1m to 28d).</td></tr>
    <tr><td><code>reason</code> <span class="opt">optional</span></td><td>text</td><td>Optional reason for the log.</td></tr>
    <tr><td><code>delete_days</code> <span class="opt">optional</span></td><td>number</td><td>Days of their messages to delete (0 to 7). Defaults to 0.</td></tr>
  </table>
  <div class="dc" style="margin-top:1rem;">
