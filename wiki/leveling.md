...
<p style="color:var(--fg-1);font-size:.9rem;line-height:1.55;">The top three get gold, silver and bronze medals; everyone else lines up below. If nobody's earned any XP yet, the bot simply says <em>“No XP yet, get chatting (or vote for Server Assistant)!”</em></p>
